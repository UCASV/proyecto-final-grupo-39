...
using Proyecto_final.Functions.FConnection;
using Proyecto_final.Model;

namespace Proyecto_final.Functions
{
    public class Command
    {
        public string cnn = "Server=DESKTOP-NHNTHSU;Database=BancoDatos;Trusted_Connection=True;";
