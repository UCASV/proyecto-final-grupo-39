...
namespace Part_A.View
{
    public partial class seguimiento_de_cita : Form
    {
        ...
        private Form regresar;
       
        public seguimiento_de_cita(Form re)
        {
            InitializeComponent();
            regresar = re;
        }
        ...
        private void btnEspera_Click(object sender, EventArgs e)
        {
            ...
            ventana.Show();
            this.Hide();
            MessageBox.Show("El paciente paso a la sala de espera", "Sistema de vacunacion",
                MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            MessageBox.Show("Volviendo a seguimiento de citas ", "Sistema de vacunacion",
                MessageBoxButtons.OK, MessageBoxIcon.Information);
